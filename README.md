...
git allows you to track what each team made did and save code to restore if broken or lost

5. Define mobile-first design in your own words.

mobile first design starts with mobile scale website and @media is set to min-width; then it is build to fit bigger screens
